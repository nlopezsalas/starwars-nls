	...
	return {
		...
		actions: {
			...
			addFavorites: (name, uid, resource) => {
				...
				console.log('%cAñadir favorito....', 'padding: 5px; background-color: purple; color: white');
				if (!getStore().favorites.includes(newFavorite.name)) {
					setStore({ favorites: [...getStore().favorites, newFavorite] });
				}

				// favorites : [{ id: XXX, name: XXXX, url: XXXX }, { id: XXX, name: XXXX, url: XXXX }]
